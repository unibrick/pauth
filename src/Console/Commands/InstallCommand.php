...
namespace Unibrick\PAuth\Console\Commands;
...
class InstallCommand extends Command implements PromptsForMissingInput
{
     ...
     * @var string
     */
    protected $signature = 'pauth:install {stack : The development stack that should be installed (blade,livewire,livewire-functional,react,vue,api)}
     ...
     * @var string
     */
    protected $description = 'Install the PAuth controllers and resources';
